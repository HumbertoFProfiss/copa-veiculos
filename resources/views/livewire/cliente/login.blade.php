<div class="max-w-sm mx-auto">
    <h1 class="font-heading text-2xl font-semibold text-brand-900 dark:text-white mb-1 text-center">Entrar</h1>
    <p class="text-sm text-muted dark:text-duskmuted text-center mb-8">Acesse sua área do cliente</p>

    <form wire:submit="entrar" class="rounded-2xl border border-brand-100 dark:border-duskborder bg-white dark:bg-duskcard p-6 shadow-brand space-y-4">
        <div>
        ...
        <label class="flex items-center gap-2 text-sm text-muted dark:text-duskmuted">
            <input type="checkbox" wire:model="lembrar" class="rounded border-brand-100 dark:border-duskborder text-brand-700 focus:ring-brand-500">
            Lembrar de mim
        </label>
