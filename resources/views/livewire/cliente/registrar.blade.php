<div class="max-w-sm mx-auto">
    <h1 class="font-heading text-2xl font-semibold text-brand-900 mb-1 text-center">Criar conta</h1>
    <p class="text-sm text-muted text-center mb-8">Favorite carros e acompanhe suas compras</p>

    <form wire:submit="registrar" class="rounded-2xl border border-brand-100 bg-white p-6 shadow-brand space-y-4">
        <div>
        ...
        <div>
            <label class="block text-xs text-muted mb-1">Confirmar senha</label>
