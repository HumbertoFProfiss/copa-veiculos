<div>
    @if ($enviado)
        <div class="flex items-start gap-3 p-4 rounded-xl bg-brand-100/50 text-brand-700 text-sm">
            <x-heroicon-o-check-circle class="w-5 h-5 shrink-0" />
            <span>Recebemos seu interesse! Um vendedor vai entrar em contato em breve.</span>
        </div>
    @else
        <h3 class="font-heading text-sm font-semibold text-brand-900 mb-3">Tenho interesse</h3>
