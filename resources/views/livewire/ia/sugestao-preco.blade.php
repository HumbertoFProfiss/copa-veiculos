<div class="border-t border-border pt-4 mt-4">
    <div class="flex items-center justify-between mb-2">
        <h3 class="text-xs font-semibold text-text-secondary uppercase tracking-wide">Sugestão de preço (IA)</h3>
        @unless ($sugestaoAtual)
            <button wire:click="solicitar" wire:loading.attr="disabled" type="button" class="text-xs text-primary hover:underline disabled:opacity-60">
                ...
                <span wire:loading wire:target="solicitar">Consultando...</span>
            </button>
        @endunless
    </div>
    ...
    @if ($sugestaoAtual)
        <div class="bg-primary-soft border border-primary/20 rounded-control p-3">
            ...
            <div class="flex items-center gap-3 mt-3">
                <button wire:click="aceitar" type="button" class="text-xs font-medium text-success hover:underline">Aceitar</button>
